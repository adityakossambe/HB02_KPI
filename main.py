...
Step 1: Generate KPI Excel report (4 sheets)
Step 2: Transfer to modularity model with colour overrides
Step 3: Transfer to analysis model (coming soon)
"""
...
class FunctionInputs(AutomateBase):
    modularity_model_stream_id: str = Field(
        title="Modularity Model Stream ID",
        description="Stream ID of the target model for the modularity colour transfer.",
    )
...
def automate_function(
    ...
    # ── 3. Transfer to modularity model ──────────────────────────────────
    try:
